...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloat,              extruder_clearance_x_pos))
    ((ConfigOptionFloat,              extruder_clearance_x_neg))
    ((ConfigOptionFloat,              extruder_clearance_y_pos))
    ((ConfigOptionFloat,              extruder_clearance_y_neg))
